---
id: task-009
title: Add 'Copy Play Link' button to disk list
status: To Do
assignee: []
...
4. **Update detail template** in [templates/detail.html](templates/detail.html):
   - Add "Copy Play Link" button for each disk in the disk list
...
- [ ] #4 Copy Play Link button displayed for each disk in the list
